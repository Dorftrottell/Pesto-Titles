...
# Styles directory: configurable via env var (set by server.py),
# falling back to ~/.pesto-captions/styles/ for user-level storage.
_env_dir = os.environ.get("PESTO_STYLES_DIR", "")
STYLES_DIR = Path(_env_dir) if _env_dir else Path.home() / ".pesto-captions" / "styles"
